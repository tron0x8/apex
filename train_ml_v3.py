...
AUG_FP = [
    ...
    {'type': 'Weak Session Management', 'severity': 'MEDIUM', 'confidence': '50%',
     'code': 'session_start();', 'line': 3, 'file': 'init.php'},
    {'type': 'Weak Session Management', 'severity': 'LOW', 'confidence': '45%',
     'code': 'if (!session_id()) { session_start(); }', 'line': 5, 'file': 'bootstrap.php'},
    {'type': 'Improper Error Handling', 'severity': 'LOW', 'confidence': '50%',
     'code': '} catch (Exception $e) {}', 'line': 25, 'file': 'helper.php'},
    {'type': 'Improper Error Handling', 'severity': 'LOW', 'confidence': '45%',
     'code': '} catch (\\Exception $e) { /* ignore */ }', 'line': 35, 'file': 'utils.php'},
    {'type': 'PHAR Deserialization', 'severity': 'HIGH', 'confidence': '60%',
     'code': 'if (file_exists($pluginPath)) {', 'line': 30, 'file': 'plugins/loader.php'},
    {'type': 'PHAR Deserialization', 'severity': 'HIGH', 'confidence': '55%',
     'code': '$size = filesize($cacheFile);', 'line': 45, 'file': 'cache/manager.php'},
    {'type': 'PHAR Deserialization', 'severity': 'HIGH', 'confidence': '55%',
     'code': 'if (is_file($templatePath)) { require $templatePath; }',
     'line': 20, 'file': 'engine/template.php'},
    {'type': 'Information Disclosure', 'severity': 'LOW', 'confidence': '40%',
     'code': "'phpinfo' => 'PHP Information',", 'line': 150, 'file': 'language/english_utf-8.php'},
    {'type': 'Information Disclosure', 'severity': 'LOW', 'confidence': '40%',
     'code': "'server_info' => 'Server Information Page',", 'line': 200, 'file': 'language/german_utf-8.php'},
    {'type': 'PHPInfo Exposure', 'severity': 'MEDIUM', 'confidence': '50%',
     'code': "$features['phpinfo'] = 'Show PHP Info';", 'line': 20, 'file': 'lang/english.php'},
    {'type': 'Cross-Site Scripting', 'severity': 'MEDIUM', 'confidence': '50%',
     'code': '<?= htmlspecialchars($user->name) ?>', 'line': 12, 'file': 'views/profile.php'},
    {'type': 'Cross-Site Scripting', 'severity': 'MEDIUM', 'confidence': '50%',
     'code': '{{ $user->name }}', 'line': 8, 'file': 'resources/views/user.blade.php'},
    {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '70%',
     'code': '$etag = md5(microtime(TRUE)); // ETag for CSS caching',
     'line': 137, 'file': 'templates/style.css.php'},
    {'type': 'Weak Cryptography', 'severity': 'MEDIUM', 'confidence': '60%',
     'code': '$etag = md5($content); // HTTP ETag header',
     'line': 15, 'file': 'engine/cache.php'},
    {'type': 'Arbitrary File Write', 'severity': 'HIGH', 'confidence': '65%',
     'code': 'file_put_contents($etag_filename, $etag); // writing cached ETag',
     'line': 146, 'file': 'layout/style.css.php'},
    {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '65%',
     'code': '$etag = file_get_contents($etag_filename); // reading cached ETag',
     'line': 127, 'file': 'layout/style.css.php'},
    {'type': 'HTTP Header Injection', 'severity': 'HIGH', 'confidence': '65%',
     'code': 'header("Location: " . $_CONF["site_url"] . "/path");',
     'line': 192, 'file': 'system/lib-webservices.php'},
    {'type': 'Race Condition', 'severity': 'HIGH', 'confidence': '65%',
     'code': '$handle = fopen($path.$file, "w"); // test file cleanup',
     'line': 390, 'file': 'tests/files/classes/tests.class.php'},
    {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '70%',
     'code': '$composerPlugins = require($composerConfigFile);',
     'line': 112, 'file': 'Ip/Config.php'},
]
