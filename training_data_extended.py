...
def get_extended_fp_examples():
    ...
    return [
        ...
        # ======================================================================
        # HARDCODED PATH FILE READS - NOT SSRF (10 examples)
        # file_get_contents on local hardcoded/config paths is safe
        # ======================================================================
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '98%',
         'code': '$etag = file_get_contents($etag_filename); // cached ETag from local file',
         'line': 127, 'file': 'layout/style.css.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$config = file_get_contents(__DIR__ . "/config.json");',
         'line': 5, 'file': 'bootstrap.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '90%',
         'code': '$template = file_get_contents($theme_dir . "/header.html");',
         'line': 20, 'file': 'template_engine.php'},
        {'type': 'Server-Side Request Forgery', 'severity': 'HIGH', 'confidence': '98%',
         'code': '$css = file_get_contents($css_cache_file); // reading cached CSS from local file',
         'line': 130, 'file': 'public/layout/style.css.php'},
        {'type': 'Server-Side Request Forgery', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$data = file_get_contents($this->_logFile); // reading log file',
         'line': 50, 'file': 'classes/logger.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '80%',
         'code': '$version = file_get_contents(ROOT_PATH . "/VERSION");',
         'line': 10, 'file': 'system/info.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '90%',
         'code': '$manifest = file_get_contents(public_path("mix-manifest.json")); // Laravel mix manifest',
         'line': 15, 'file': 'app/Helpers/AssetHelper.php'},
        {'type': 'Server-Side Request Forgery', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$lock = file_get_contents($lockFile); // reading lock file for dependency check',
         'line': 8, 'file': 'installer.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '75%',
         'code': '$readme = file_get_contents(ABSPATH . "readme.html"); // WordPress readme',
         'line': 22, 'file': 'wp-admin/about.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '80%',
         'code': 'if (is_readable($etag_filename)) { $etag = file_get_contents($etag_filename); }',
         'line': 126, 'file': 'public_html/layout/denim/css/style.css.php'},

        # ======================================================================
        # NON-SECURITY RANDOMNESS - NOT INSECURE (8 examples)
        # md5(microtime/uniqid) for cache keys, etags, UUIDs is safe
        # ======================================================================
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$etag = md5(microtime(TRUE)); // ETag for HTTP caching, not security token',
         'line': 137, 'file': 'layout/style.css.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '80%',
         'code': '$cache_key = md5(microtime() . $request_uri); // cache bust key',
         'line': 25, 'file': 'cache_manager.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '65%',
         'code': '$uuid = md5(uniqid("", true)); // non-security UUID for logging',
         'line': 45, 'file': 'feed/Atom.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '70%',
         'code': '$boundary = md5(microtime()); // MIME boundary for email',
         'line': 30, 'file': 'mailer.php'},
        {'type': 'Insecure Randomness', 'severity': 'MEDIUM', 'confidence': '60%',
         'code': '$tmp_name = "tmp_" . md5(microtime()) . ".dat"; // temp file name',
         'line': 12, 'file': 'upload_handler.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '75%',
         'code': '$form_id = "form_" . md5(uniqid()); // HTML form identifier, not CSRF',
         'line': 8, 'file': 'form_builder.php'},
        {'type': 'Insecure Randomness', 'severity': 'MEDIUM', 'confidence': '65%',
         'code': '$trace_id = substr(md5(microtime(true)), 0, 8); // request tracing ID',
         'line': 3, 'file': 'middleware/tracing.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$etag = md5(microtime(TRUE)); @file_put_contents($etag_filename, $etag); // cache etag',
         'line': 146, 'file': 'layout/modern_curve/style.css.php'},

        # ======================================================================
        # CONFIG FILE INCLUSIONS - NOT LFI (8 examples)
        # require/include on config-derived hardcoded paths is safe
        # ======================================================================
        {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$composerPlugins = require($composerConfigFile); // loading composer plugin config',
         'line': 112, 'file': 'Ip/Config.php'},
        {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$config = array_merge($config, require($envConfigFile)); // environment config file',
         'line': 277, 'file': 'Ip/Config.php'},
        {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '80%',
         'code': 'require_once __DIR__ . "/../vendor/autoload.php"; // Composer autoloader',
         'line': 3, 'file': 'public/index.php'},
        {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '75%',
         'code': 'require_once($this->configDir . "/database.php"); // app config',
         'line': 50, 'file': 'system/core/Config.php'},
        {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '70%',
         'code': 'include(APPPATH . "config/" . ENVIRONMENT . "/routes.php"); // CI routing config',
         'line': 25, 'file': 'system/core/Router.php'},
        {'type': 'File Inclusion', 'severity': 'HIGH', 'confidence': '80%',
         'code': '$routes = require(dirname(__DIR__) . "/config/routes.php"); // config loader',
         'line': 15, 'file': 'src/Kernel.php'},
        {'type': 'File Inclusion', 'severity': 'MEDIUM', 'confidence': '65%',
         'code': 'if (file_exists($langfile)) { require_once $langfile; } // language file based on constant',
         'line': 90, 'file': 'admin/install/rescue.php'},
        {'type': 'Path Traversal', 'severity': 'HIGH', 'confidence': '85%',
         'code': 'if (is_file(__DIR__ . "/" . $url["path"])) { return false; } // PHP built-in server router check',
         'line': 21, 'file': 'start-pack/index.php'},

        # ======================================================================
        # TEST FILE / DEBUG CODE FPs (5 examples)
        # Code in test/ directories is not production
        # ======================================================================
        ...
        {'type': 'Information Disclosure', 'severity': 'MEDIUM', 'confidence': '65%',
         'code': 'var_dump($XML_RPC_xh[$parser]["value"]); // debug output behind $this->debug flag',
         'line': 1505, 'file': 'classes/XML/RPC.php'},
        {'type': 'Information Disclosure', 'severity': 'MEDIUM', 'confidence': '65%',
         'code': 'print_r($this); // debug render method in Latex converter, not web-facing',
         'line': 21, 'file': 'Text/Wiki/Render/Latex/Html.php'},
        {'type': 'Race Condition', 'severity': 'HIGH', 'confidence': '65%',
         'code': 'if (!$file = fopen($this->_logFile, "a")) { $this->setLogging(false); } // log file append',
         'line': 258, 'file': 'classes/upload.class.php'},
        {'type': 'Race Condition', 'severity': 'HIGH', 'confidence': '65%',
         'code': 'if (!$file = fopen($this->_logFile, "a")) { $this->setLogging(false); } // downloader log',
         'line': 175, 'file': 'classes/downloader.class.php'},

        # ======================================================================
        # SAFE HEADER / CONFIG-DRIVEN REDIRECTS (5 examples)
        # ======================================================================
        {'type': 'HTTP Header Injection', 'severity': 'HIGH', 'confidence': '85%',
         'code': 'header("Location: " . $_CONF["site_url"] . "/webservices/atom/?plugin=" . $WS_PLUGIN); // config URL',
         'line': 192, 'file': 'system/lib-webservices.php'},
        {'type': 'HTTP Header Injection', 'severity': 'HIGH', 'confidence': '85%',
         'code': 'header("Etag: \\"" . $out["updated"] . "\\""); // ETag from DB, not user input',
         'line': 366, 'file': 'system/lib-webservices.php'},
        {'type': 'HTTP Header Injection', 'severity': 'HIGH', 'confidence': '80%',
         'code': 'header("Location: " . $config["base_url"] . "/dashboard"); // config-based redirect',
         'line': 15, 'file': 'auth/login.php'},
        {'type': 'HTTP Header Injection', 'severity': 'MEDIUM', 'confidence': '70%',
         'code': 'header("Content-Type: " . $mime_types[$ext]); // extension-to-mime lookup',
         'line': 30, 'file': 'file_server.php'},
        {'type': 'HTTP Header Injection', 'severity': 'HIGH', 'confidence': '75%',
         'code': 'header("X-Powered-By: MyApp/" . APP_VERSION); // constant version string',
         'line': 5, 'file': 'bootstrap.php'},
    ]
...
def get_extended_tp_examples():
    ...
    return [
        ...
        # Wrapper function / indirect taint TP examples
        {'type': 'Arbitrary File Write', 'severity': 'CRITICAL', 'confidence': '90%',
         'code': 'file_put_contents($up_dir . $fn, file_get_contents("php://input")); // raw body to disk',
         'line': 44, 'file': 'admin/plugins/auto_post/uploads-require-maxsite.php'},
        {'type': 'Arbitrary File Write', 'severity': 'CRITICAL', 'confidence': '85%',
         'code': '$file = base64_decode($post["file_path"]); file_put_contents($file, $post["content"]);',
         'line': 15, 'file': 'admin/plugins/editor_files/save-file-ajax.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '80%',
         'code': '$file = base64_decode($post["file"]); echo file_get_contents($file);',
         'line': 10, 'file': 'admin/plugins/editor_files/load-file-ajax.php'},
        {'type': 'Arbitrary File Write', 'severity': 'CRITICAL', 'confidence': '90%',
         'code': 'file_put_contents($_POST["path"], $_POST["data"]); // direct user-controlled write',
         'line': 8, 'file': 'admin/file_manager.php'},
        {'type': 'Arbitrary File Read', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$content = file_get_contents(base64_decode($_POST["f"])); echo $content;',
         'line': 12, 'file': 'ajax/read_file.php'},
        {'type': 'SQL Injection', 'severity': 'CRITICAL', 'confidence': '85%',
         'code': '$sql = sprintf("UPDATE %s SET value = \'%s\'", $_TABLES["conf"], serialize($_POST[$config]));',
         'line': 274, 'file': 'admin/install/rescue.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '65%',
         'code': '$emailconfirmid = substr(md5(uniqid(rand(), 1)), 1, 16); // email verification token',
         'line': 1466, 'file': 'system/lib-user.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '85%',
         'code': '$_SESSION["token"] = md5(uniqid(rand(), 1)); // CSRF session token using weak rand()',
         'line': 113, 'file': 'classes/htmLawed/htmLawedTest.php'},
        {'type': 'Weak Cryptography', 'severity': 'HIGH', 'confidence': '65%',
         ...
         'line': 135, 'file': 'Ip/Lib/PasswordHash.php'},
        {'type': 'Insecure Randomness', 'severity': 'HIGH', 'confidence': '65%',
         'code': '$public_key = substr(md5(uniqid(rand(),true)), 0, $this->chars); // captcha key',
         'line': 676, 'file': 'Ip/Lib/HnCaptcha/HnCaptcha.php'},
    ]
