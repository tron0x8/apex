...
class LLMAnalyzer:
    ...
    def __init__(self, backend: Optional[str] = None,
        ...
        if self.fast_mode:
            self._code_limit = 2000
            self._max_tokens_verify = 150
            self._max_tokens_hunt = 400
            self._max_tokens_auth = 400
            self._verify_context_lines = 10
            self._ollama_timeout = 600
            self._batch_size = 2
            self._batch_context_chars = 200
        else:
