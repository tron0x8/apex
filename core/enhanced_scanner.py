...
class EnhancedScanner:
    ...
    def _init_sanitizers(self):
        self.sanitizers = {
            ...
            'addslashes': {VulnType.SQL_INJECTION},
            ...
            'filter_var': {VulnType.XSS, VulnType.SQL_INJECTION},
